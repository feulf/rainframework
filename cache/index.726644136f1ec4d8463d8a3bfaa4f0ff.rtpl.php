...
<body>
	...
	<div id="footer">
		<div id="inner_footer">
			<div class="left"><?php $counter1=-1; if( isset($menu) && is_array($menu) && sizeof($menu) ) foreach( $menu as $key1 => $value1 ){ $counter1++; ?><?php if( $counter1 ){ ?> | <?php } ?><a href="http://localhost/github/rainframework/<?php echo $value1["link"]; ?>" <?php if( $value1["selected"] ){ ?>class="selected"<?php } ?>><?php echo $value1["name"]; ?></a><?php } ?></div>
