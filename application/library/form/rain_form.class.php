<?php
	...
	// add style
	add_style( "default.css", APPLICATION_LIBRARY_DIR ."form/tpl/" );
	...
	class Rain_Form{
		...
		function Rain_Form( $action = null, $method="get", $name = null, $target=null, $layout = "default" ){
			...
			require_once APPLICATION_LIBRARY_DIR . "form/tpl/$layout.php";	// include theme
		...
		function draw( $return_string = false, $ajax = false ){
			...
			$html = '<div id="'.$this->name.'_loading" style="display:none;"><img src="'.URL.APPLICATION_LIBRARY_DIR.'form/tpl/img/loading.gif" alt="loading"/>Loading</div>' . "\n" .
		...
		function _word( $name, $value, $param){
			...
			add_script( "jquery.tinymce.js", APPLICATION_LIBRARY_DIR . "form/plugins/tiny_mce/" );
