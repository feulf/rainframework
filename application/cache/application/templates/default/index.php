...
<head>
	...
	<link rel="stylesheet" href="http://localhost/github/rainframework/application/templates/default/css/style.css" type="text/css" />
</head>
<body>
	
	<div id="header" class="doc">
		<div id="menu"><div><img src="http://localhost/github/rainframework/application/templates/default/img/logo_mini.png"><?php $counter1=-1; if( isset($menu) && is_array($menu) && sizeof($menu) ) foreach( $menu as $key1 => $value1 ){ $counter1++; ?><a href="http://localhost/github/rainframework/<?php echo $value1["link"];?>" <?php echo $value1["selected"]?'class="selected"':null;?>><?php echo $value1["name"];?></a><?php } ?></div>
	</div>
